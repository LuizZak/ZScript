...
public interface IZScriptListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterTrailingIfStatement([NotNull] ZScriptParser.TrailingIfStatementContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="ZScriptParser.trailingIfStatement"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitTrailingIfStatement([NotNull] ZScriptParser.TrailingIfStatementContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterForEachStatement([NotNull] ZScriptParser.ForEachStatementContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterTupleType([NotNull] ZScriptParser.TupleTypeContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterTupleAccess([NotNull] ZScriptParser.TupleAccessContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="ZScriptParser.tupleAccess"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitTupleAccess([NotNull] ZScriptParser.TupleAccessContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterTupleLiteralInit([NotNull] ZScriptParser.TupleLiteralInitContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="ZScriptParser.tupleLiteralInit"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitTupleLiteralInit([NotNull] ZScriptParser.TupleLiteralInitContext context);
	/// <summary>
